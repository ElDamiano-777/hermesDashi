...
def _setup_cli(subparser: Any) -> None:
    ...
    p_setup = subs.add_parser("setup", help="Update the profile-local Suno plugin .env values")
...
def register(ctx: Any) -> None:
    ...
    _register_tool(ctx, "suno_preview_state", schemas.SUNO_PREVIEW_STATE, tools.suno_preview_state)
